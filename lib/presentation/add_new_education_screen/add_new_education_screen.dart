...
import 'package:job_seeking_app/widgets/custom_drop_down.dart';
...
class AddNewEducationScreen extends GetWidget<AddNewEducationController> {
  ...
  Future<void> onTapRowsmalllabelregultwo() async {
    DateTime? dateTime = await showDatePicker(
        ...
        initialDate: controller
            .addNewEducationModelObj.value.selectedSmalllabelregulTwoTxt,
  ...
  Future<void> onTapRowsmalllabelregulthree() async {
    DateTime? dateTime = await showDatePicker(
        context: Get.context!,
        initialDate: controller
            .addNewEducationModelObj.value.selectedSmalllabelregulThreeTxt,
        firstDate: DateTime(1970),
        lastDate: DateTime(
            DateTime.now().year, DateTime.now().month, DateTime.now().day));
    if (dateTime != null) {
