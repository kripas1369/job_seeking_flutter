...
import 'package:job_seeking_app/widgets/custom_text_form_field.dart';
import 'package:job_seeking_app/data/models/register/post_register_req.dart';
import 'package:job_seeking_app/data/models/register/post_register_resp.dart';
import 'package:job_seeking_app/core/constants/user.dart';
import 'package:job_seeking_app/core/constants/role.dart';
...
class SignUpCompleteAccountScreen
  ...
  void _onOnTapSignUpSuccess() {
    Get.offNamed(AppRoutes.jobTypeScreen);
  }
